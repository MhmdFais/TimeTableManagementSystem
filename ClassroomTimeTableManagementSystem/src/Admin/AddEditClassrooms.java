 ...
 * @author Asus
 */
public class AddEditClassrooms extends javax.swing.JFrame {

    /**
     * Creates new form UserSettings
     */
    public AddEditClassrooms() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Student Capacity");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddEditClassrooms().setVisible(true);
            }
        });
    }
