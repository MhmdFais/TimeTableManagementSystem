...
public class AddEditResources extends javax.swing.JFrame {
    ...
    @SuppressWarnings("unchecked")
          ...
          private void initComponents() {
                    ...
                    jResCombo = new javax.swing.JComboBox<>();
                    ...
                    jResCombo.setFont(new java.awt.Font("Poppins Medium", 0, 18)); // NOI18N
                    jResCombo.setForeground(new java.awt.Color(64, 134, 200));
                    jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "White Board", "Projector" }));
                    jResCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "White Board", "Projector", "Mraker", "Seat" }));
                    jResCombo.setBorder(null);
                    jResCombo.addActionListener(new java.awt.event.ActionListener() {
                              public void actionPerformed(java.awt.event.ActionEvent evt) {
                                        jResComboActionPerformed(evt);
                              }
                    });
                    getContentPane().add(jResCombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 170, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new UserSettings().setState(java.awt.Frame.NORMAL);
          ...
          private void jResComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jResComboActionPerformed
                    // TODO add your handling code here:
          }//GEN-LAST:event_jResComboActionPerformed
          ...
          private void jAddResActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAddResActionPerformed
                    ...
                    String item = jResCombo.getSelectedItem().toString();
                    int selectedQuantity = ((Integer) jSpinQuan.getValue()); 
                    
                    Resource obj = new Resource();
                    
                    obj.add(classroom, item, selectedQuantity);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
          ...
          private javax.swing.JComboBox<String> jResCombo;
